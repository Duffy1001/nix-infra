...
in {
  options.infra.root.zvolCreate.enable = lib.mkOption { type = lib.types.bool; default = true; description = "Whether to realize planned ZFS zvols with systemd units."; };
