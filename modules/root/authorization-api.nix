...
in {
  options.infra.root.authorizationApi.enable = lib.mkOption { type = lib.types.bool; default = true; description = "Whether to run the state volume authorization API skeleton."; };
